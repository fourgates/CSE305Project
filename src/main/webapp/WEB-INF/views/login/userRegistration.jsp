<%-- 
    ...
    Created on : Dec 5, 2013, 3:06:57 AM
    Author     : funfun
--%>
                ...
                <div class="span9" >
                    <div class="hero-unit">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td> Creation Date: </td><td><input class="form-control" name="Creation Date" placeholder="Creation Date" type="text"></td>
                            </tr>
                            <tr>
                                <td> Rating: </td><td><input class="form-control" name="Rating" placeholder="Rating" type="text"> </td>
                            </tr>
                            <tr>
