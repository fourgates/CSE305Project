			...
			<div class="span9">
				<div class="hero-unit">
					...
					<table class="table table-striped">
						<tr>
							<th style="width: 84px"><span style="font-size: 10pt">First
									Name</span></th>
							<th style="width: 84px"><span style="font-size: 10pt">Last
									Name</span></th>
						...
						<td><button class="btn btn-default" type="button">Add
								to my circle</button></td>
					...
					<table class="table table-striped">
						...
						<td><button class="btn btn-default" type="button">Join
								circle</button></td>
					</table>
				</div>
			</div>
