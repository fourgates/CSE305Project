<%-- 
    Document   : comment
    Created on : Dec 4, 2013, 11:58:10 AM
    Author     : funfun
--%>
                    ...
                    <div class="hero-unit">
                        ...
                        <table class="table table-striped">
                            <tr>
                                ...
                                <th style="width: 84px"><span style="font-size: 10pt"> Comment
                                        ID</span></th>
                                <th style="width: 84px"><span style="font-size: 10pt">Date
                                    </span></th> 
                                <th style="width: 84px"><span style="font-size: 10pt">Content</span></th>
                                <th style="width: 84px"><span style="font-size: 10pt">Post   </span></th>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body" style="background-color: white">
                                ...
                                <button class="btn btn-default" type="button"> New comment </button>
